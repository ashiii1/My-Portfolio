        ...
        <Modal open={true} onClose={closeHandler}>
            ...
            >
                <Wrapper>
                    ...
                    <ButtonGroup>
                        <Button href={project?.website} target="_blank" rel="noopener noreferrer">Website</Button>
                        <Button href={project?.github} target="_blank" rel="noopener noreferrer">Code</Button>
                    </ButtonGroup>
                </Wrapper>
            </Container>
        </Modal>
